...
import (
	...
	"github.com/IBM/fsgo/internal/common"
)
...
func (iofs IOFS) Glob(pattern string) ([]string, error) {
	...
	// fsgo.Glob does not perform this check but it's required for implementations
...
// readDirFile provides adapter from fsgo.File to fs.ReadDirFile needed for correct Open
